...
При возникновении ошибок загрузки данных снизу появляется дополнительная панель уведомлений. На ней есть кнопка "Обновить", которая позволяет обновить всю систему.
