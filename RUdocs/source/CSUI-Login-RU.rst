...
Навигационную панель можно спрятать или расрыть, используя переключатель "<"/">" вверху. Позиция навигационной панели запоминается системой и при входе/выходе из системы, перезагрузке страницы, передвижении от раздела к разделу не меняется. 
...
При возникновении ошибок загрузки данных снизу появляется дополнительная панель уведомлений. На ней есть кнопка "Обновить", которая позволяет перезагрузить всю систему.
