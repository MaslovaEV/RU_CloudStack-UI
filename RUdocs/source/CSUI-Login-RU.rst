...
Слева находится главная навигационную панель. Она позволяет перемещаться от раздела к разделу. Навигационная панель формируется Администратором в конфигурационном файле (см. подробнее :ref:`configureSidenav_RU`). Администратор может сделать ее редактируемой, т.е. разрешить пользователю менять порядок элементов в главной навигационной панели (кроме раздела *Выход*). См. подробнее :ref:`allowReorderingSidenav_RU` для получения дополнительной информации об установке настроек навигационной панели.
...
.. note:: Раздел *Виртуальные Машины* нельзя выключить из списка разделов в навигиационной панели. Его можно только  перемещать по списку. 

.. figure:: _static/RU_NavBar_Adjust.png

Навигационную панель можно спрятать или раскрыть, используя переключатель |hide menu| вверху. Позиция навигационной панели запоминается системой и не меняется при входе/выходе из системы, перезагрузке страницы, передвижении от раздела к разделу. 
