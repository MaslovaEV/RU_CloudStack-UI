...
Если навигационная панель редактируемая, вверху нее вы увидите иконку |lock|. Чтобы изменить порядок разделов навигационной панели, нажмите на эту иконку для редактирования меню: 
