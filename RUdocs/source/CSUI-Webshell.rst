...
Потребность в данном плагине обусловлена недостатками интерфейса NoVNC, которые ограничивают его использование для рашения каждодневных администраторских задач:
