...
Лимит времени сеанса можно установить в конфигурационном файле. См. подробнее в руководстве по конфигурациям :ref:`SessionTimeout_RU`.
...
Цвет темы можно установить в конфигурационном файле JSON. См.подробнее в руководстве по конфигурациям :ref:`ThemeName_RU`. 
