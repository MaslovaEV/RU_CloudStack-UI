...
.. note:: Для только что созданных снимков в списке действий доступно только действие "Удалить", т.к. снимок еще не скопирован во вторичное хранилище. Как только снимок будет скопирован во вторичное хранилище (что может занять некоторое время), для него будет доступен полный список действий.
