...
1. Вкладка "Диск" — Содержит следующую информацию о диске:
...
2. Вкладка "Снимки" — Содержит информацию о снимках диска, если они есть. Позволяет сделать снимок диска. Снимки можно делать только для дисков со статусом Готов.
